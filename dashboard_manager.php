...
<head>
    ...
    // Menu Transaction Temp
    $("#m_transaction_temp").click(function() {
        loadTransactionTemp();
    });

    $("#contentData").on("click", "#addTransactionTemp", function() {
        $.ajax({
    ...
    $("#contentData").on("submit", "#formTransactionTemp", function(e) {
        e.preventDefault();
        $.ajax({
    ...
    $("#contentData").on("click", "#deleteTransactionTemp", function() {
    ...
    $("#contentData").on("click", "#editTransactionTemp", function() {
        var id_transaction = $(this).attr("value");
        $.ajax({
    ...
    $("#contentData").on("submit", "#formEditTransactionTemp", function(e) {
        e.preventDefault();
        $.ajax({
    ...
    function loadTransactionTemp() {
        $.ajax({
            url: 'transaction_temp/list.php',
            type: 'get',
            success: function(data) {
                $('#contentData').html(data);
            }
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard_manager.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" id="m_transaction_temp">Transaksi</a>
                    </div>
                </div>
            </li>
